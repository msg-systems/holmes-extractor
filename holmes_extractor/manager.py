...
class Manager:
    ...
    def get_supervised_topic_training_basis(
            ...
            overlap_memory_size:int=10, one_hot:bool=True, match_all_words:bool=False,
        ...
        return SupervisedTopicTrainingBasis(
            ...
            overlap_memory_size=overlap_memory_size, one_hot=one_hot,
