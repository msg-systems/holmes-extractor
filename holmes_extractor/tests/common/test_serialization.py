...
class SerializationTest(unittest.TestCase):
    ...
    def test_subwords(self):
        ...
        german_holmes_manager.parse_and_register_document("Bundesoberbehörde.", 'bo')
        serialized_doc = german_holmes_manager.serialize_document('bo')
        german_holmes_manager.deserialize_and_register_document(serialized_doc, 'bo2')
        old_doc = german_holmes_manager.threadsafe_container.get_document('bo')
        new_doc = german_holmes_manager.threadsafe_container.get_document('bo2')
