...
class MultiprocessingTest(unittest.TestCase):
    ...
    def test_workers_specified(self):
        ...
        self.assertEqual(m.topic_match_documents_returning_dictionaries_against(
                ...
                [{'document_label': 'exact', 'text': 'The dog chased the animal', 'text_to_match': 'A dog chases an animal', 'rank': '1', 'sentences_character_start_index_in_document': 0, 'sentences_character_end_index_in_document': 25, 'score': 99.34666666666668, 'word_infos': [[4, 7, 'overlapping_relation', False], [8, 14, 'overlapping_relation', False], [19, 25, 'overlapping_relation', True]]}, {'document_label': 'specific', 'text': 'I saw a dog. It was chasing a cat', 'text_to_match': 'A dog chases an animal', 'rank': '2', 'sentences_character_start_index_in_document': 0, 'sentences_character_end_index_in_document': 33, 'score': 81.94686666666668, 'word_infos': [[8, 11, 'overlapping_relation', False], [20, 27, 'overlapping_relation', False], [30, 33, 'overlapping_relation', True]]}, {'document_label': 'exact-reversed', 'text': 'The animal chased the dog', 'text_to_match': 'A dog chases an animal', 'rank': '3=', 'sentences_character_start_index_in_document': 0, 'sentences_character_end_index_in_document': 25, 'score': 35.39866666666667, 'word_infos': [[4, 10, 'single', False], [11, 17, 'relation', False], [22, 25, 'relation', True]]}, {'document_label': 'specific-reversed', 'text': 'The cat chased the dog', 'text_to_match': 'A dog chases an animal', 'rank': '3=', 'sentences_character_start_index_in_document': 0, 'sentences_character_end_index_in_document': 22, 'score': 34.486666666666665, 'word_infos': [[4, 7, 'single', False], [8, 14, 'relation', False], [19, 22, 'relation', True]]}])
        m.close()
    ...
    def test_number_of_results(self):
        ...
        self.assertEqual(m.topic_match_documents_returning_dictionaries_against(
                ...
                [{'document_label': 'exact', 'text': 'The dog chased the animal', 'text_to_match': 'A dog chases an animal', 'rank': '1', 'sentences_character_start_index_in_document': 0, 'sentences_character_end_index_in_document': 25, 'score': 99.34666666666668, 'word_infos': [[4, 7, 'overlapping_relation', False], [8, 14, 'overlapping_relation', False], [19, 25, 'overlapping_relation', True]]}, {'document_label': 'specific', 'text': 'I saw a dog. It was chasing a cat', 'text_to_match': 'A dog chases an animal', 'rank': '2', 'sentences_character_start_index_in_document': 0, 'sentences_character_end_index_in_document': 33, 'score': 81.94686666666668, 'word_infos': [[8, 11, 'overlapping_relation', False], [20, 27, 'overlapping_relation', False], [30, 33, 'overlapping_relation', True]]}, {'document_label': 'exact-reversed', 'text': 'The animal chased the dog', 'text_to_match': 'A dog chases an animal', 'rank': '3', 'sentences_character_start_index_in_document': 0, 'sentences_character_end_index_in_document': 25, 'score': 35.39866666666667, 'word_infos': [[4, 10, 'single', False], [11, 17, 'relation', False], [22, 25, 'relation', True]]}])
        m.close()
    ...
    def _internal_test_multithreading_topic_matching(self, number_of_workers):
        ...
        for i in range(NUMBER_OF_THREADS):
            ...
            self.assertEqual(reversed_dict, [{'document_label': 'exact-reversed', 'text': 'The animal chased the dog', 'text_to_match': 'The animal chased the dog', 'rank': '1=', 'sentences_character_start_index_in_document': 0, 'sentences_character_end_index_in_document': 25, 'score': 96.93333333333334, 'word_infos': [[4, 10, 'overlapping_relation', False], [11, 17, 'overlapping_relation', True], [22, 25, 'overlapping_relation', False]]}, {'document_label': 'specific-reversed', 'text': 'The cat chased the dog', 'text_to_match': 'The animal chased the dog', 'rank': '1=', 'sentences_character_start_index_in_document': 0, 'sentences_character_end_index_in_document': 22, 'score': 87.446, 'word_infos': [[4, 7, 'overlapping_relation', False], [8, 14, 'overlapping_relation', True], [19, 22, 'overlapping_relation', False]]}, {'document_label': 'exact', 'text': 'The dog chased the animal', 'text_to_match': 'The animal chased the dog', 'rank': '3=', 'sentences_character_start_index_in_document': 0, 'sentences_character_end_index_in_document': 25, 'score': 30.598666666666666, 'word_infos': [[4, 7, 'relation', False], [8, 14, 'relation', False], [19, 25, 'single', True]]}, {'document_label': 'specific', 'text': 'I saw a dog. It was chasing a cat', 'text_to_match': 'The animal chased the dog', 'rank': '3=', 'sentences_character_start_index_in_document': 0, 'sentences_character_end_index_in_document': 33, 'score': 27.704, 'word_infos': [[8, 11, 'relation', False], [20, 27, 'relation', True], [30, 33, 'single', False]]}])
